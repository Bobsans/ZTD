...
namespace SFML {
	...
	namespace Graphics {
		...
		public class RenderTexture : ObjectBase, IRenderTarget {
			...
			////////////////////////////////////////////////////////////
			public RenderTexture(uint width, uint height) : this(width, height, false) { }
			...
			public override string ToString() {
				return "[RenderTexture] Size(" + Size + ") Texture(" + Texture + ") DefaultView(" + DefaultView + ") View(" + GetView() + ")";
			}

	...
	namespace Window {
		...
		public class KeyEventArgs : EventArgs {
			...
			public override string ToString() {
				return "[KeyEventArgs] Code(" + Code + ") Alt(" + Alt + ") Control(" + Control + ") Shift(" + Shift + ") System(" + System + ")";
			}
		...
		public class JoystickMoveEventArgs : EventArgs {
			...
			/// <returns>String description of the object</returns>			
			public override string ToString() {
				return "[JoystickMoveEventArgs] JoystickId(" + JoystickId + ") Axis(" + Axis + ") Position(" + Position + ")";
			}
		...
		public class JoystickButtonEventArgs : EventArgs {
			...
			/// <returns>String description of the object</returns>			
			public override string ToString() {
				return "[JoystickButtonEventArgs] JoystickId(" + JoystickId + ") Button(" + Button + ")";
			}
		...
		public class JoystickConnectEventArgs : EventArgs {
			...
			/// <returns>String description of the object</returns>
			public override string ToString() {
				return "[JoystickConnectEventArgs] JoystickId(" + JoystickId + ")";
			}
		...
		public class TouchEventArgs : EventArgs {
			...
			/// <returns>String description of the object</returns>		
			public override string ToString() {
				return "[TouchEventArgs] Finger(" + Finger + ") X(" + X + ") Y(" + Y + ")";
			}
		...
		public class SensorEventArgs : EventArgs {
			...
			public override string ToString() {
				return "[SensorEventArgs] Type(" + Type + ") X(" + X + ") Y(" + Y + ") Z(" + Z + ")";
			}
